<?php
/**
 * Plugin Name: Markdown Maker
 * Plugin URI: https://github.com/yourusername/markdown-maker
 * Description: Developer-focused plugin to convert WordPress posts/pages to clean, LLM-ready Markdown
 * Version: 1.0.0
 * Author: Your Name
...
add_action( 'init', 'markdown_maker_handle_download' );